	...
	<div class="main">
		...
		<div class="demo">
			...
			<div class="booking-details">
				...
				<form action="../web/movie-payment.php?uid=1&cost=total&qty=count&mid=<?php echo $mid ?>&sid=<?php echo $sid ?>" method="post"><ul id="selected-seats" class="scrollbar scrollbar1"></ul><input type="submit" value="Book Now" class="checkout-button" ></form>
