...
if($_POST["submit"]) {
    ...
    $mail->Subject = "Subscription Form to email message for TicketGo";
    $mail->Body = "$_POST[senderEmail]";
...
<html>
<head>
<title>TicketGo | Subscribe</title>
...
<!-- AddThis Smart Layers END -->
	...
	<p class="love"> Subscribe to us by filling in the form below</p>
