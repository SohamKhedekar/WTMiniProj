		...
		<div class="e-payment-section">
			<div class="col-md-8 payment-left">
				<div class="confirm-details">
					...
					<h4 style="padding-top: 10px;"><strong>Email:</strong> &nbsp <?php echo $row['email'] ?></h4>
                    <h4 style="padding-top: 10px;"><strong>Mobile:</strong> &nbsp <?php echo $row['mobile'] ?></h4>
					...
					<p style="padding-top: 10px;"><i>Your number will be used for transaction confirmations & none of those painful promotions.</i></p>
					<!-- <div class="c-lang">
				...
				<div class="payment-options">
					...
					<div class="tab-grids event-tab-grids">
						<div id="tab1" class="tab-grid">
							...
							<form action="event-payment-single.php?">
								<!-- uid=1&cost=<?php echo $total ?>&qty=<?php echo $qty ?>&eid=<?php echo $eid ?>&sid=<?php echo $sid ?>&scost=<?php echo $cost ?>&fees=<?php echo $fees ?> -->
							<input type="hidden" name="uid" value="1" />
    						<input type="hidden" name="cost" value="<?php echo $total ?>" />
    						<input type="hidden" name="qty" value="<?php echo $qty ?>" />
    						<input type="hidden" name="eid" value="<?php echo $eid ?>" />
    						<input type="hidden" name="sid" value="<?php echo $sid ?>" />
    						<input type="hidden" name="scost" value="<?php echo $cost ?>" />
    						<input type="hidden" name="fees" value="<?php echo $fees ?>" />
                            <?php 
                                foreach($x as $value)
                                {
                                  echo '<input type="hidden" name="myCheckbox[]" value="'. $value. '">';
                                }
                            ?>
							<input type="text" class="payment" pattern="^(?:4[0-9]{12}(?:[0-9]{3})?|[25][1-7][0-9]{14}|6(?:011|5[0-9][0-9])[0-9]{12}|3[47][0-9]{13}|3(?:0[0-5]|[68][0-9])[0-9]{11}|(?:2131|1800|35\d{3})\d{11})$" placeholder="xxxxxxxxxxxxxxxx" required onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter Your Card Number';}">
							<input type="text" class="payment" placeholder="Name on Card" required onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Your Name On Card';}">
							<p>Expiry:<select required class="month">
													...
													<select required class="year">
														...
														<input type="text" class="cvv" placeholder="CVV" required onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'cvv';}"> <!-- pattern="/^[0-9]{3,4}$/"  -->
														</p>
														<!-- <a href="event-payment-single.php?uid=1&cost=<?php echo $total ?>&qty=<?php echo $qty ?>&eid=<?php echo $eid ?>&sid=<?php echo $sid ?>&scost=<?php echo $cost ?>&fees=<?php echo $fees ?>"> --><input type="submit" class="go-to-pay" value="make payment"><!-- </a> --></form>
						</div>
					...
					<label class="lang">KOTAK bank</label>
                        ...
                        <div class="col-md-6">
                            <form class="cc-form">
                                ...
                                <a href="event-payment-single.php"><input class="btn btn-primary" type="submit" value="Proceed Payment"></a>
                            </form>
                        </div>
                    </div>
						</div> -->
