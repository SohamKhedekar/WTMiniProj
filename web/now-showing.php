...
<html>
<head>
<title>TicketGo a Entertainment Category Flat Bootstarp responsive Website Template | Now-Showing :: w3layouts</title>
	...
	<!-- <div class="now-showing-movies">
		...
		<div class="col-md-4 movie-preview">
			<a href="movie-single.php" class="mask">
				...
				<div class="m-movie-title">
					<a class="m-movie-link" href="movie-single.php">Baby</a>
					<div class="clearfix"></div>
					<div class="m-r-date">
		...
		<div class="col-md-4 movie-preview">
			<a href="movie-single.php" class="mask">
				...
				<div class="m-movie-title">
					<a class="m-movie-link" href="movie-single.php">Bezubaan Ishq (U)</a>
					<div class="clearfix"></div>
					<div class="m-r-date">
						<p><i class="fa fa-calendar-o"></i>3 Jul, 2015</p>
					</div>
		...
		<div class="col-md-4 movie-preview">
			<a href="movie-single.php" class="mask">
				...
				<div class="m-movie-title">
					<a class="m-movie-link" href="movie-single.php">Guddu Rangeela (U/A)</a>
					<div class="clearfix"></div>
					<div class="m-r-date">
						<p><i class="fa fa-calendar-o"></i>3 Jul, 2015</p>
					</div>
		...
		<div class="col-md-4 movie-preview">
			<a href="movie-single.php" class="mask">
				...
				<div class="m-movie-title">
					<a class="m-movie-link" href="movie-single.php">James Bond</a>
					<div class="clearfix"></div>
					<div class="m-r-date">
						<p><i class="fa fa-calendar-o"></i>3 Jul, 2015</p>
					</div>
		...
		<div class="col-md-4 movie-preview">
			<a href="movie-single.php" class="mask">
				...
				<div class="m-movie-title">
					<a class="m-movie-link" href="movie-single.php">Malupu</a>
					<div class="clearfix"></div>
					<div class="m-r-date">
						<p><i class="fa fa-calendar-o"></i>3 Jul, 2015</p>
					</div>
		...
		<div class="col-md-4 movie-preview">
			<a href="movie-single.php" class="mask">
				...
				<div class="m-movie-title">
					<a class="m-movie-link" href="movie-single.php">Online Binline</a>
					<div class="clearfix"></div>
					<div class="m-r-date">
						<p><i class="fa fa-calendar-o"></i>3 Jul, 2015</p>
					</div>
		...
		<div class="footer">
			...
			<div class="copy-rights text-center">
				<p>© 2017 TicketGo. All Rights Reservedf</p>
			</div>
	</div>
 <script type="text/javascript">
