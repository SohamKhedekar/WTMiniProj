				...
				<div class="payment-options">
					...
					<div class="tab-grids event-tab-grids">
						<div id="tab1" class="tab-grid">
							...
							<form action="movie-payment-single.php?">
							...
							<p>Expiry:<select required class="month">
													...
													<select required class="year">
														...
														<input type="text"  class="cvv" placeholder="CVV" required> <!-- pattern="/^[0-9]{3,4}$/" -->
														</p>
														<input type="submit" class="go-to-pay" value="make payment"></form>
						</div>
		...
		<script>
			...
			<div class="payment-right">
								<?php 
									...
									$sql = "SELECT s.sdate, s.stime, m.name FROM screening1 AS s, Movie1 AS m WHERE m.mid = '$mid' AND s.sid = '$sid';";
									$result = mysqli_query($conn, $sql);
									...
									$sql1 = "SELECT a.theatrename FROM screening1 AS s, auditorium AS a WHERE s.mid = '$mid' AND a.aid = s.aid;";
				...
				<h6><span>Movie-Name:</span><?=$row["name"]?></h6>
				<p><span>Theatre:</span> <?=$row1["theatrename"]?> </p>
