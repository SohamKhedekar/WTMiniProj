...
<!-- AddThis Smart Layers END -->
	...
	<!-- <section class="help-center">	
			<div class="hc-search">
				...
				<div class="support1">
				<form>
					<input type="text" class="text" value="Enter your search term here..." onfocus="this.value = '';" onblur="if (this.value == 'Enter email...') {this.value = 'Enter your search term here...';}">
				    <input type="submit" value="SEARCH" class="botton">
				</form>
				</div>
			</div>
			<div class="hc-nav">				
				<a href="#"> New support ticket</a>
				<a href="#">Check ticket status</a>
			</div>
			<div class="clearfix"></div>
		</section> -->
			   ...
			   <div class="support_grids">	
				<div class="section group">
				  <div class="col-md-4 support-grid text-center">
					 <h4>Feedback</h4>
					  <h5>Help us get better</h5>
					<!-- <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p> -->
				      <a href="feed-back.php">Enter Feedback</a>
				</div>
				<div class="col-md-4 support-grid text-center">
					<h4>Email support</h4>
					<h5>We promise a turnaround within 24 hrs.</h5>
					<!-- <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p> -->
				...
				<div class="col-md-4 support-grid text-center">
					...
					<!-- <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p> -->
				    <a href="faq.php">Search Our F.A.Q's</a>
				 </div>		
				<div class="clearfix"></div>
			</div>
  	 	  </div> 
