...
<!-- AddThis Smart Layers END -->
	...
	<div class="faq">
		<h3>Welcome to TicketGo Help</h3>
		<div class="faqs">
								     <h3 class="event-tab-head">FAQs</h3>
									 <div class="tab1">
							<ul class="place">
								<li>Q1.Refund for cancelled shows</li>
							</ul>
						<p class="ans" style="display: none;">Ans. In case an event or show is cancelled due to unforeseen circumstances, the transaction will be refunded and depending on each bank's policy, it can sometimes take up to 5-7 working days or 10 working days incase of a nationalised bank. </p>
						</div>
						<div class="tab2">
							<ul class="place">
								<li>Q2.Refund for a failed transaction</li>
							</ul>
						<p class="ans" style="display: none;">Ans. The amount is refunded from our end within 2 hours and should reflect in your respective wallet or account within 5-7 working days. In case it is a nationalized bank, it may take a max of 10 working days to reflect.</p>
						</div>
						<div class="tab3">
							<ul class="place">
								<li>Q3. How can I confirm whether my tickets have been booked? </li>
							</ul>
						<p class="ans" style="display: none;">Ans. As soon as your booking is confirmed, a confirmation e-mail containing your booking details would be sent across to your contact details entered while booking. </p>
						</div>
						
						<div class="tab4">
							<ul class="place">
								<li>Q4.Can I cancel my tickets? </li>
							</ul>
						<p class="ans" style="display: none;"> As per event policies, we will not be able to cancel/refund the tickets. What you can do is transfer the tickets to a friend or someone who can make it to the show. Just ask them to carry the following things to the box office.
						a) A valid id proof
						b) A copy of the E-ticket you transferred in their name, which s/he will receive and in their mail and via text message.
						Please note that online transfers can only be carried out until 24 hours before the event. </p>
						</div>
						<div class="tab5">
							<ul class="place">
								<li>Q5.Where do I pick up my tickets? </li>
							</ul>
						<p class="ans" style="display: none;"> You can collect your physical passes in exchange of your e-ticket at the venue on the day of the event. Just turn up at the box office with the e-ticket (either the mail or just the SMS both would work) and valid ID proof to pick up your passes. Don't forget to tell us how you liked it.</p>
						</div>
						<div class="tab6">
							<ul class="place">
								<li>Q6.Can I book my tickets without my credit card since I don't want to disclose my credit card details? </li>
							</ul>
						<p class="ans" style="display: none;"> All credit card and debit card payments on Insider are processed through secure and trusted payment gateways managed by leading Indian banks. Banks in India now use the 3D Secure password service for online transactions, providing an additional layer of security through identity verification.
						Alternately you can pay via net banking. Everybody wins!</p>
						</div>
						<div class="tab7">
							<ul class="place">
								<li>Q7.Do I have to print the ticket? </li>
							</ul>
						<p class="ans" style="display: none;"> We are an eco-friendly bunch, you see. You can either show us the e-ticket (That we emailed you) on your phone or just the message (SMS) you received after you booked your ticket, containing the shortcode.Go green!</p>
						</div>
