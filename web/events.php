        ...
        <!--
            <div id="defaultmenu" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown w3_megamenu-fw active"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Events<b class="caret"></b></a>
                        <ul class="dropdown-menu half">
                            <li class="w3_megamenu-content withdesc">
                                <div class="row">
...
<!-- AddThis Smart Layers END -->
    ...
    <div class="event-slider">    
          <div class="callbacks_container">
              <ul class="rslides" id="slider">
                 <li>
                     <img src="images\Mughal-E-Azam.jpg" alt=""/>
                      <div class="caption">
                        <h2>Mughal-E-Azam </h2>
                        <p>The classic movie Mughal-e-Azam is turned into a spectacular stage musical. The timeless love story of Prince Salim and the courtesan Anarkali is the stuff of legends. For the love of this beautiful young woman, Salim rebelled and went to war against his father Emperor Akbar. With the glamour of Manish Malhotra costumes, technical expertise from Broadway and original hit songs such as Pyar kiya to darna kya and Teri mehfil mein kismet aazma kar, the production promises to be an exhilarating experience!</p>
                        <a class="more" href="events-ticket-booking.php?id=1">Book Now</a>
                      </div>
                 </li>
                 <li>
                     <img src="images\Headliners.jpg" alt=""/>
                      <div class="caption">
                        <h2>HEADLINERS! </h2>
                        <p>A stand-up show featuring the biggies of the comedy world', 'Rohan Joshi, Biswa Kalyan Rath, Rahul Subramanian, Gaurav Kapoor', 'Biswa Kalyan Rath'</p>
                        <a class="more" href="events-ticket-booking.php?id=4">Book Now</a>
                      </div>
                 </li>
                 <li>
                     <img src="images\Lazy Writing by Abhishek Upmanyu.jpg" alt=""/>
                      <div class="caption">
                        <h2>Lazy Writing by Abhishek Upmanyu </h2>
                        <p>A riot of laughter in a colonial ambience is sure to make Lazy Writing by Abhishek Upmanyu the third Stand-Up Comedy event an absolute memorable one!</p>
                        <a class="more" href="events-ticket-booking.php?id=5">Book Now</a>
                      </div>
                 </li>
              </ul>       
          </div>
 ...
 <script>
    ...
    <div class="event-search">
                      <form>
                         <input type="text" value="Search for venue or plays" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search for venue or plays';}">
                        <i class="fa fa-search"></i>
                      </form>
                    </div>
                    -->
    ...
    <div class="grid_3 grid_5">
            ...
            <ul id="myTab" class="nav nav-tabs" role="tablist">
              <li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">This Weekend</a></li>
            <!--  <li role="presentation"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile">Tomorrow</a></li>
              <li role="presentation"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile">This Weekend</a></li> -->
            </ul>
            <div id="myTabContent" class="tab-content">
              <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">                  
                  <div class="events-grids">
                        <div class="col-md-4 event-grid">
                            <a href="event-single.html"><img src="images\Mughal-E-Azam.jpg" alt="" /></a>
                            <div class="event-info">
                                <a class="m-movie-link" href="#">Mughal-E-Azam</a>
                                <span>Jamshed Bhabha Theatre :: NCPA</span>
                                <p><label>This weekend</label> 4 Nov - 5 Nov 2017</p>
                                <a class="e-green" href="#">Romance</a>
                                <div class="clearfix"></div>
                                <a class="buy" href="events-ticket-booking.php?id=1">buy tickets</a>
                            </div>
                        </div>
                        <div class="col-md-4 event-grid">
                            <a href="event-single.html"><img src="images\Dhumrapaan.jpg" alt="" /></a>
                            <div class="event-info">
                                <a class="m-movie-link" href="#">Dhumrapaan</a>
                                <span>Prithvi Theatre</span>
                                <p><label>This weekend</label> 6 Nov - 7 Nov 2017</p>
                                <a class="e-green" href="#">Drama</a>
                                <div class="clearfix"></div>
                                <a class="buy" href="events-ticket-booking.php?id=2">buy tickets</a>
                            </div>
                        </div>
                        <div class="col-md-4 event-grid">
                            <a href="event-single.html"><img src="images\WWE Live India.jpg" alt="" /></a>
                            <div class="event-info">
                                <a class="m-movie-link" href="#">WWE Live India 2017</a>
                                <span>NCPA</span>
                                <p><label>This weekend</label> 3 Nov - 7 Nov 2017</p>
                                <a class="e-green" href="#">Adventure</a>
                                <div class="clearfix"></div>
                                <a class="buy" href="events-ticket-booking.php?id=3">buy tickets</a>
                            </div>
                        </div>                
                        <div class="col-md-4 event-grid">
                            <a href="event-single.html"><img src="images\Headliners.jpg" alt="" /></a>
                            <div class="event-info">
                                <a class="m-movie-link" href="#">HEADLINERS</a>
                                <span>Canvas Laugh Club</span>
                                <p><label>This weekend</label> 3 Nov - 6 Nov 2017</p>
                                <a class="e-green" href="#">Comedy</a>
                                <div class="clearfix"></div>
                                <a class="buy" href="events-ticket-booking.php?id=4">buy tickets</a>
                            </div>
                        </div>
                        <div class="col-md-4 event-grid">
                            <a href="event-single.html"><img src="images\Lazy Writing by Abhishek Upmanyu.jpg" alt="" /></a>
                            <div class="event-info">
                                <a class="m-movie-link" href="#">Lazy Writing by Abhishek Upmanyu</a>
                                <span>Canvas Laugh Club</span>
                                <p><label>This weekend</label> 4 Nov - 5 Nov 2017</p>
                                <a class="e-green" href="#">Comedy</a>
                                <div class="clearfix"></div>
                                <a class="buy" href="events-ticket-booking.php?id=5">buy tickets</a>
                            </div>
                        </div>
                  <div class="clearfix"></div>
              </div>
...
<div class="clearfix"></div>    
    ...
    <!--
        <div class="footer">
            ...
            <div class="copy-rights text-center">
                <p>© 2015 TicketGo. All Rights Reserved | Design by <a href="http://w3layouts.com/">W3layouts</a></p>
            </div>
    </div>
    -->
    <div class="footer">
 ...
 <script type="text/javascript">
                ...
                <a href="#gotop" class="scroll" id="toTop" style="display: block;"> <span id="toTopHover" style="opacity: 1;"> </span></a>
</body>
</html>