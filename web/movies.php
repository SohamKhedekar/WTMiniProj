         ...
         <div class="banner col-md-8">
            <section class="slider">
                <div class="flexslider">
                        ...
                        <li>
                            <img src="C:\Users\TANAY\Downloads\my_show-web\web\images\golmaal4.jpg" class="img-responsive" alt="" />
                        </li>
                        <li>
                            <img src="C:\Users\TANAY\Downloads\my_show-web\web\images\ironman3.jpg" class="img-responsive" alt="" />
                        </li>
    ...
    <div class="now-showing-movies">
        ...
        <div class="col-md-6 movie-preview">
            <a href="movie-single.html" class="mask">
                <img src="images\b4.jpg" class="img-responsive zoom-img" alt="" />
                <div class="m-movie-title">
                    <a class="m-movie-link" href="movie-single.php?id=1">Terminator Genisys (U/A)</a>
                    <div class="clearfix"></div>
                    <div class="m-r-date">
                        <p><i class="fa fa-calendar-o"></i>2015-07-02</p>
                        <a href="movie-single.php?id=1">book now</a>
                    </div>
                    <!-- <div class="m-r-like">
        ...
        <div class="col-md-6 movie-preview">
            <a href="movie-single.html" class="mask">
                <img src="images\iron.jpg" class="img-responsive zoom-img" alt="" />
                <div class="m-movie-title">
                    <a class="m-movie-link" href="movie-single.php?id=2">Iron Man 3 (U/A)</a>
                    <div class="clearfix"></div>
                    <div class="m-r-date">
                        <p><i class="fa fa-calendar-o"></i>2013-04-25</p>
                        <a href="movie-single.php?id=2">book now</a>
                    </div>
                    <div class="m-r-like">
                        <i class="fa fa-thumbs-up"></i>
                        <p>rocking</p>
        ...
        <div class="col-md-6 movie-preview">
            <a href="movie-single.html" class="mask">
                <img src="images\golmaal.jpg" class="img-responsive zoom-img" alt="" />
                <div class="m-movie-title">
                    <a class="m-movie-link" href="movie-single.php?id=4">Golmaal Again (U/A)</a>
                    <div class="clearfix"></div>
                    <div class="m-r-date">
                        <p><i class="fa fa-calendar-o"></i>2017-10-20</p>
                        <a href="movie-single.php?id=4">book now</a>
                    </div>
                    <div class="m-r-like">
                        <i class="fa fa-thumbs-up"></i>
                        <p>rocking</p>
        ...
        <div class="col-md-6 movie-preview">
            <a href="movie-single.html" class="mask">
                <img src="images\movie-show.jpg" class="img-responsive zoom-img" alt="" />
                <div class="m-movie-title">
                    <a class="m-movie-link" href="movie-single.php?id=3">Baahubali: The Beginning (U/A)</a>
                    <div class="clearfix"></div>
                    <div class="m-r-date">
                        <p><i class="fa fa-calendar-o"></i>2015-07-10</p>
                        <a href="movie-single.php?id=3">book now</a>
                    </div>
                    <div class="m-r-like">
                        <i class="fa fa-thumbs-up"></i>
                        <p>rocking</p>
        ...
        <div class="col-md-4 movie-preview">
            <a href="movie-single.html" class="mask">
                ...
                <div class="m-movie-title">
                    <a class="m-movie-link" href="movie-single.php?id=5">The Vatican Tapes(A)</a>
                    <div class="clearfix"></div>
                    <div class="m-r-date">
                        <p><i class="fa fa-calendar-o"></i>2015-07-31</p>
                        <a href="movie-single.php?id=5">book now</a>
                    </div>
                    <!-- <div class="m-r-like">
                        <i class="fa fa-thumbs-up"></i>
                        <p>rocking</p>
                                    ...
                                    <ul class="tab_img">
                                      <li>
                                        <div class="view view-first">
                                          <a href="movie-select-show.html"> <img src="images/r4.jpg" class="img-responsive" alt=""/></a>
                                           <div class="info1"> </div>
                                             <div class="mask">
                                             </div>
                                              <div class="tab_desc">
                                      ...
                                      <li>
                                        <div class="view view-first">
                                           <a href="movie-select-show.html"><img src="images/r3.jpg" class="img-responsive" alt=""/></a>
                                           <div class="info1"> </div>
                                             <div class="mask">
                                             </div>
                                              <div class="tab_desc" style="padding-top: 20px">
                                                    <a href="movie-single.php?id=2">Book Now</a>
                                                    <div class="percentage-w-t-s">
                                                        <h5>80</h5>
                                                        <p>% <br> Want to see</p>
            ...
            <div class="right-side-bar">
                <div class="top-movies-in-india">
                    ...
                    <ul class="mov_list">
                        ...
                        <li>77%</li>
                        <li><a href="movie-single.html">Terminator Genisys (English) (3D) (U/A)</a></li>
                    </ul>
                    <ul class="mov_list">
                        <li><i class="fa fa-star"></i></li>
                        <li>80%</li>
                        <li><a href="movie-single.html">Iron Man 3 (English) (U/A)</a></li>
                    </ul>
                    <ul class="mov_list">
                        <li><i class="fa fa-star"></i></li>
                        <li>90%</li>
                        <li><a href="movie-single.html">Baahubali: The Beginning (Hindi) (U/A)</a></li>
                    </ul>
                    <ul class="mov_list">
                        <li><i class="fa fa-star"></i></li>
                        <li>85%</li>
                        <li><a href="movie-single.html">Golmaal Again (Hindi) (U/A)</a></li>
                    </ul>
                    <ul class="mov_list">
                        <li><i class="fa fa-star"></i></li>
                        <li>69%</li>
                        <li><a href="movie-single.html">The Vatican Tapes (English) (U/A)</a></li>
                    </ul>
                    <!--
                    <ul class="mov_list">
                        <li><i class="fa fa-star"></i></li>
